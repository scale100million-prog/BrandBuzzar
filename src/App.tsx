    ...
    <div className="min-h-screen bg-[#FDFDFF] font-sans text-[#1A1A2E] pb-24">
      ...
      <header className="relative pt-6 md:pt-12 pb-0 px-4 text-center">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            Attention Manufacturers<br className="md:hidden" /> in Gujarat: <span className="text-[#FF8A00] block mt-2">Your Next Big Order Is Already Going to a Competitor.</span>
          </motion.h1>
